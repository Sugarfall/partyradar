...
export const GLASGOW_VENUES: DemoVenue[] = [
  ...
  { id: 'venue-g21', name: 'Bloc+',               address: '117 Bath St, Glasgow G2 2SZ',           city: 'Glasgow', lat: 55.8631, lng: -4.2641, type: 'BAR',          rating: 4.3, vibeTags: ['electronic', 'DJ', 'indie', 'underground'],    isClaimed: false },
  { id: 'venue-g22', name: 'The Horseshoe Bar',   address: '17-21 Drury St, Glasgow G2 5AE',        city: 'Glasgow', lat: 55.8617, lng: -4.2548, type: 'PUB',          rating: 4.5, vibeTags: ['live music', 'karaoke', 'traditional', 'singing'], isClaimed: false },
  { id: 'venue-g23', name: 'The State Bar',       address: '148 Holland St, Glasgow G2 4NG',        city: 'Glasgow', lat: 55.8638, lng: -4.2690, type: 'PUB',          rating: 4.4, vibeTags: ['live music', 'open mic', 'indie', 'rock'],     isClaimed: false },
  { id: 'venue-g24', name: 'Ben Nevis',           address: '1147 Argyle St, Glasgow G3 8TB',        city: 'Glasgow', lat: 55.8651, lng: -4.2862, type: 'PUB',          rating: 4.4, vibeTags: ['folk', 'live music', 'whisky', 'traditional'], isClaimed: false },
  { id: 'venue-g25', name: 'Solid Rock Café',     address: '21-23 Hope St, Glasgow G2 6AB',         city: 'Glasgow', lat: 55.8608, lng: -4.2526, type: 'BAR',          rating: 4.2, vibeTags: ['rock', 'metal', 'live music', 'DJ'],          isClaimed: false },
  { id: 'venue-g26', name: 'Viper',               address: '150 Queen St, Glasgow G1 3BX',          city: 'Glasgow', lat: 55.8616, lng: -4.2510, type: 'NIGHTCLUB',    rating: 3.8, vibeTags: ['RnB', 'hip hop', 'club night'],               isClaimed: false },
  { id: 'venue-g27', name: 'O2 Academy Glasgow',  address: '121 Eglinton St, Glasgow G5 9NT',       city: 'Glasgow', lat: 55.8518, lng: -4.2571, type: 'CONCERT_HALL', rating: 4.4, vibeTags: ['concerts', 'live music', 'mainstream'],       isClaimed: false },
  { id: 'venue-g28', name: 'The Art School',      address: '20 Scott St, Glasgow G3 6PE',           city: 'Glasgow', lat: 55.8672, lng: -4.2699, type: 'CONCERT_HALL', rating: 4.3, vibeTags: ['indie', 'alternative', 'student', 'live music'], isClaimed: false },
]
